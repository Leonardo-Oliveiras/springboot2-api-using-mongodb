package com.leonardooliveira.courseproject.config;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "My first comment", "Thank you!", maria);
		Post post2 = new Post(null, sdf.parse("21/03/2018"), "My second comment", "I really liked it!", maria);
